export const content = {
  en: {
    ...
    hero: {
      ...
      desc: "I build and ship full-stack systems in production — REST APIs, cloud infrastructure, and complete web apps. Sole developer at Tubertico. Open to remote roles worldwide.",
      cta1: 'View Projects',
      cta2: 'Download CV',
    },
    about: {
      ...
      badge: "🟢 Actively looking for remote junior Full Stack or Backend roles worldwide",
    },
    stack: {
      label: 'Stack',
      title: 'Technologies',
  ...
  es: {
    ...
    hero: {
      ...
      desc: "Construyo y despliego sistemas full stack en producción — APIs REST, infraestructura cloud y aplicaciones web completas. Único desarrollador en Tubertico. Disponible para roles remotos en cualquier parte del mundo.",
      cta1: 'Ver Proyectos',
      cta2: 'Descargar CV',
    },
    about: {
      ...
      badge: "🟢 En búsqueda activa de roles remotos junior como Desarrollador Full Stack o Backend en cualquier parte del mundo",
    },
    stack: {
      label: 'Stack',
      title: 'Tecnologías',
